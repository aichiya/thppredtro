...
_OaksLabCharmanderText:: ; Left orb
	text "So! You want the"
	line "Magician <pkmn>,"
	cont "Chibi Marisa?"
	done

_OaksLabSquirtleText:: ; Middle orb
	text "So! You want the"
	line "Miko <pkmn>,"
	cont "Chibi Reimu?"
	done

_OaksLabBulbasaurText:: ; Right orb
	text "So! You want the"
	line "maid <pkmn>,"
	cont "Chibi Sakuya?"
	done
...
_OaksLabText_symbolsON::
	...
	para "Did you know"
	line "many <pkmn> can"
	cont "be either yin- or"
	cont "yang-affected?"
	
	para "I can modify the"
	line "TH-Dex to show a"
